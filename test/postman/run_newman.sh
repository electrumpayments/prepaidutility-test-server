...
newman run ${testdir}/PrepaidUtilityTestPack.postman_collection.json -e ${testdir}/PPU${host}test.postman_environment.json -d ${testdir}/test_meterIds-keychange.csv -n 1 --folder "Key change"
